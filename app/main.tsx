...
export default function Layout() {
  ...
  return (
    <SafeAreaView
      ...
      style={{ backgroundColor: '#171717', zIndex: 99 }}
    >
      <View className="flex h-full flex-row justify-end overflow-hidden">
        <View className="h-full w-20 bg-neutral-900" style={{ zIndex: 99 }}>
          <ScrollView
            bounces={false}
